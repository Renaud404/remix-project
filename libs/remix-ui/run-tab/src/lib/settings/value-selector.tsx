  ...
  return (
    <div className="remixui_crow">
      ...
      <div className="remixui_gasValueContainer">
        <input type="text" className="form-control remixui_gasNval remixui_col2" id="value" value={parseInt(gasValue)} onChange={(e) => setGasValue((e.target as HTMLInputElement).value)} title="Enter the value and choose the unit" />
